...
class PlayerViewModel(val playerInteractor: MediaPlayerInteractor) : ViewModel() {
    ...
    fun preparePlayer() {
        ...
        playerInteractor.initMediaPlayer().setOnCompletionListener {
            ...
            playerInteractor.initPlayerState(MediaPlayerState.STATE_PREPARED)
        }
    ...
    fun startPlayer() {
        ...
        playerInteractor.initPlayerState(MediaPlayerState.STATE_PLAYING)
    ...
    fun pausePlayer() {
        ...
        playerInteractor.initPlayerState(MediaPlayerState.STATE_PAUSED)
